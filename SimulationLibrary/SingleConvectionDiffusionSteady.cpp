...
SingleConvectionDiffusionSteady::SingleConvectionDiffusionSteady(Mesh* mesh, const double viscosity,
                                                                 const double tolerance, const std::string output_file)
    : SingleConvectionDiffusionSimulation(mesh, viscosity, tolerance, output_file, SimulationType::Steady) {
}

void SingleConvectionDiffusionSteady::solve() {
    m_timer->start_timer();
    ...
    m_saver->write_simulation_name(SimulationName::SingleConvectionDiffusionSteady);
