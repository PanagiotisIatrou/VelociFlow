#include "PressureCorrectionEquation.hpp"

#include <cmath>

PressureCorrectionEquation::PressureCorrectionEquation(Mesh *mesh, const Field variable_field, const double relaxation_factor,
...
void PressureCorrectionEquation::calculate_mass_imbalance() {
...
double PressureCorrectionEquation::get_mass_imbalance() const {
    return m_mass_imbalance;
}

void PressureCorrectionEquation::reset_mass_imbalance() {
    m_mass_imbalance = std::numeric_limits<double>::infinity();
}

double PressureCorrectionEquation::get_mass_imbalance_normalization_factor() const {
    return m_mass_imbalance_normalization_factor;
}

void PressureCorrectionEquation::set_mass_imbalance_normalization_factor(const double factor) {
